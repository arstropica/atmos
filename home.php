...
<div class="container main">
    <div class="layout-row row">
        <div class="layout-column featured col-md-<?php echo $grid_values['row']; ?> <?php echo $grid_classes['row']; ?>">
        ...
        <div class="layout-column main col-md-<?php echo $grid_values['sidebar']; ?> <?php echo $grid_classes['sidebar']; ?>">
            <?php get_sidebar('primary'); ?>
        </div><!--!layout-column-->
    </div><!--!.layout-row-->
    <div class="layout-row row">
        <div class="layout-column main col-md-<?php echo $grid_values['full']; ?> <?php echo $grid_classes['full']; ?>">
            <?php if (have_posts()) : ?>
                <div class="row content-row post-wrapper eq-parent">
                    <?php
                    // Start the Loop.
