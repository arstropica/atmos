...
<html <?php language_attributes(); ?>>
    ...
    $at_companylogo = at_responsive_get_companylogo();
    ?>
            ...
            <nav class="navbar navbar-inverse <?php echo $sticky_nav ? 'navbar-fixed-top' : ''; ?>" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand mobile visible-xs" href="#"><?php echo strtoupper(at_responsive_get_page_title($pagename)); ?></a>
                    </div>    
                </div>
                <div class="container nav-container">
                    <div class="navbar-body row">
                        <div class="navbar-layout layout-top navbar-layout col-md-8 col-sm-12">
                            <?php if ($at_companylogo) : ?><a class="navbar-brand desktop hidden-xs" href="<?php echo get_site_url(); ?>"><img class="navbar-logo" width="208" src="<?php echo $at_companylogo; ?>" /></a><?php endif; ?>
